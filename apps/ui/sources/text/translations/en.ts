...
export const en = {
    ...
    server: {
        ...
        relayDrift: {
            ...
            bannerAccountMismatchTitle: 'Your background service is signed in as a different account',
            bannerAccountMismatchDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) =>
                `The app is using ${activeRelayUrl}, but this computer’s background service is signed in as a different account.`,
...
settingsSession: {
    ...
    setupSurface: {
        ...
        stageVerifyStatus: ({ relay }: { relay: string }) => `Checking that this computer answers on ${relay}.`,
        blockedTitle: 'Setup stopped',
        blockedStatusFallback: 'Setup could not finish. Your account and your sessions are untouched.',
        blockedServiceConflictStatus: 'Another background service on this computer has to be sorted out first. Nothing was changed — open Details to see which one.',
        blockedConsentDeclinedStatus: 'Setup stopped before changing anything. The background service already on this computer was left exactly as it was.',
        blockedPairingDeclinedStatus: 'This computer wasn’t approved to connect. Nothing was changed.',
        ...
        canceledStatus: 'Nothing was left half-done. Running setup again continues from here.',
        ...
        relayMoveTitle: 'Move the background service to this Relay?',
        relayMoveBody: ({ relay }: { relay: string }) => `This computer\u2019s background service is running on a different Relay. Move it to ${relay}?`,
        relayMoveConfirm: 'Move it',
        relayMoveKeep: 'Keep it as is',
        relayMoveAlways: 'Always move it',
