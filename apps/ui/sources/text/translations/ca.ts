...
export const ca: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        sessionListGrouping: {
            ...
            flatTitle: 'Cap',
            flatSubtitle: 'Totes les sessions en una llista, sense capçaleres de grup',
        },
  ...
  newSession: {
    ...
    server: {
        ...
        relayDrift: {
            ...
            bannerAccountMismatchTitle: 'El teu servei en segon pla té la sessió iniciada amb un altre compte',
            bannerAccountMismatchDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) =>
                `L’aplicació fa servir ${activeRelayUrl}, però el servei en segon pla d’aquest ordinador té la sessió iniciada amb un altre compte.`,
    ...
    sessionsList: {
        ...
        moveSheetTitle: ({ item }: { item: string }) => `Mou ${item}`,
        moveSheetDestinationLabel: 'Destinació',
        moveSheetSubmit: 'Mou',
        moveSheetSearchPlaceholder: 'Cerca carpetes…',
        moveSheetEmpty: 'No hi ha destinacions disponibles',
        moveSheetDestinations: 'Destinacions',
        moveSheetDisabledDescendant: 'No es pot moure dins de si mateix ni d’una subcarpeta.',
        moveSheetDisabledMaxDepth: 'Se superaria el límit de profunditat de carpetes.',
        moveSheetDisabledCurrent: 'Ja és en aquesta ubicació.',
        moveSheetDisabledUnavailable: 'Aquesta destinació no està disponible.',
        dragHandleA11yLabel: 'Nansa d’arrossegament',
        dragA11yPickedUp: ({ item }: { item: string }) => `S’ha agafat ${item}.`,
        dragA11yDroppedReorder: ({ item, destination }: { item: string; destination: string }) => `S’ha mogut ${item} a prop de ${destination}.`,
        dragA11yDroppedNest: ({ item, destination }: { item: string; destination: string }) => `S’ha mogut ${item} dins de ${destination}.`,
        dragA11yDroppedRoot: ({ item, destination }: { item: string; destination: string }) => `S’ha mogut ${item} a ${destination}.`,
        dragA11yCancelled: ({ item }: { item: string }) => `S’ha cancel·lat el moviment de ${item}.`,
        dragA11yBlocked: ({ item, reason }: { item: string; reason: string }) => `No s’ha pogut moure ${item}: ${reason}`,
        dragA11yBlockedDescendantCycle: 'la destinació és dins de la carpeta moguda',
        dragA11yBlockedLeafCannotBeParent: 'les sessions no poden contenir altres elements',
        dragA11yBlockedMaxDepth: 's’ha assolit el límit de profunditat de carpetes',
        dragA11yBlockedSamePosition: 'ja és en aquesta posició',
        dragA11yBlockedWorkspaceScope: 'la destinació és en un altre espai de treball',
        dragA11yBlockedNoTarget: 'no s’ha seleccionat cap destinació',
        dragA11yBlockedDirectSession: 'les sessions directes no es poden moure a carpetes',
        dragA11yBlockedFeatureDisabled: 'les carpetes de sessions no estan activades',
        ...
        selectionSelectedCount: ({ count }: { count: number }) => count === 1 ? '1 sessió seleccionada' : `${count} sessions seleccionades`,
        selectionA11ySelectedCount: ({ count }: { count: number }) => count === 1 ? '1 sessió seleccionada' : `${count} sessions seleccionades`,
        ...
        selectionProgress: ({ completed, total }: { completed: number; total: number }) => `${completed} de ${total} completades`,
        selectionCancelRunningA11yLabel: 'Cancel·la l\'acció sobre les sessions seleccionades',
        selectionResult: ({ succeeded, failed, skipped }: { succeeded: number; failed: number; skipped: number }) => `${succeeded} correctes, ${failed} fallides, ${skipped} omeses`,
        selectionDismissResultA11yLabel: 'Descarta el resultat de l\'acció sobre les sessions seleccionades',
        selectionConfirm: ({ action, count }: { action: string; count: number }) => `${action} ${count} ${count === 1 ? 'sessió seleccionada' : 'sessions seleccionades'}?`,
        selectionConfirmA11yLabel: ({ action }: { action: string }) => `Confirma ${action}`,
        selectionMoveSheetSourceLabel: ({ count }: { count: number }) => `${count} ${count === 1 ? 'sessió seleccionada' : 'sessions seleccionades'}`,
        orderingMode: {
            ...
            created: 'Ordena per data de creació',
            updated: 'Ordena per l’última activitat',
        },
        attentionSectionTitle: 'Requereix atenció',
        activeSectionTitle: 'Actives',
        inactiveSectionTitle: 'Inactives',
        pinnedSectionTitle: 'Fixades',
        reminders: {
...
settingsSession: {
    ...
    setupSurface: {
        ...
        stageVerifyStatus: ({ relay }: { relay: string }) => `Comprovant que aquest ordinador respon a ${relay}.`,
        blockedTitle: 'Configuració aturada',
        blockedStatusFallback: 'La configuració no ha pogut acabar. El teu compte i les teves sessions són intactes.',
        blockedServiceConflictStatus: 'Primer cal resoldre un altre servei en segon pla d’aquest ordinador. No s’ha canviat res: obre Detalls per veure quin és.',
        blockedConsentDeclinedStatus: 'La configuració s’ha aturat abans de canviar res. El servei en segon pla que ja hi havia en aquest ordinador s’ha deixat tal com estava.',
        blockedPairingDeclinedStatus: 'Aquest ordinador no s’ha aprovat per connectar-s’hi. No s’ha canviat res.',
        ...
        canceledStatus: 'No ha quedat res a mitges. Tornar a executar la configuració continua des d’aquí.',
        ...
        relayMoveTitle: 'Vols moure el servei en segon pla a aquest Relay?',
        relayMoveBody: ({ relay }: { relay: string }) => `El servei en segon pla d\u2019aquest ordinador s\u2019executa en un altre Relay. El vols moure a ${relay}?`,
        relayMoveConfirm: 'Mou-lo',
        relayMoveKeep: 'Deixa’l com està',
        relayMoveAlways: 'Mou-lo sempre',
